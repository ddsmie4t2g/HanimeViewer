...
object DataStoreManager : SettingsStore {
    ...
    private fun Preferences.toAppSettings(): AppSettings = AppSettings(
        ...
        appendCustomMirrorPath = bool("append_custom_mirror_path", defaults.appendCustomMirrorPath), extraMirrorsJson = string("extra_mirrors_json", defaults.extraMirrorsJson), selfHealLogJson = string("self_heal_log_json", defaults.selfHealLogJson), pinnedSearchesJson = string("pinned_searches_json", defaults.pinnedSearchesJson), followedArtistsJson = string("followed_artists_json", defaults.followedArtistsJson), accountJson = string("account_json", defaults.accountJson),
